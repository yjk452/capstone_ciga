...
# 1. 파일 로드
#ckpt_path = "outputs/mlp_v1_train_partition/checkpoints/epoch=43-step=30000.ckpt" # 현재 병합된 파일명
ckpt_path = "outputs/mlp_v3_train_partition/checkpoints/epoch=43-step=30000.ckpt" 
...
# 4. 수정된 체크포인트 저장
torch.save(ckpt, "outputs/mlp_v3_train_partition/checkpoints/merge_fixed.ckpt")
...
# 7. 수정된 체크포인트 저장
import os
save_path = "outputs/mlp_v3_train_partition/checkpoints/merge_fixed_v2.ckpt"
